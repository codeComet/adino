...
const AssetManagementServiceHero = ({ hero }) => {
  if (!hero) {
    return (
  ...
  return (
    <div className="py-30 pb-10 w-wrapper mx-auto">
      <div className="flex items-center gap-4 mb-10 md:mb-20">
        <h4 className="uppercase w-[150px] text-[14px] font-lato font-normal text-[#666666]">
          our services
        </h4>
...
export default AssetManagementServiceHero;
